cask "notras" do
  version "0.1.2"
  sha256 "2e4c608a49802c99bd554a8dfec5d2f99dc08c4acbe3a41cce7406352be7a8f8"

  url "https://github.com/jimmy-guzman/notras/releases/download/v#{version}/notras_0.1.2_universal.dmg"
  name "notras"
